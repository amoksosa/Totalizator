...
<head>
    ...
    <title>Player Registration Codes</title>
...
<body class="min-h-screen bg-slate-100">
    ...
    <nav class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <div>
                <h1 class="text-xl font-bold text-slate-800">Player Registration Codes</h1>
                <p class="text-sm text-slate-500">Generate codes for player registration</p>
            </div>
    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-2xl shadow p-6 mb-6 flex items-center justify-between gap-4">
            <div>
                <h2 class="text-lg font-bold text-slate-800">Create New Player Code</h2>
                <p class="text-sm text-slate-500">
                    Give this code to a player. The player will still need admin approval after registering.
                </p>
            </div>

            <form method="POST" action="{{ route('agent.player-codes.store') }}">
                @csrf
